...
class SnubaTestCase(BaseTestCase):
    ...
    def store_event(self, *args, **kwargs):
        with mock.patch('sentry.eventstream.insert',
                       self.snuba_eventstream.insert):
            with mock.patch('sentry.tagstore.delay_index_event_tags',
                       self.snuba_tagstore.delay_index_event_tags):
                with mock.patch('sentry.tagstore.incr_tag_value_times_seen',
                       self.snuba_tagstore.incr_tag_value_times_seen):
                    with mock.patch('sentry.tagstore.incr_group_tag_value_times_seen',
